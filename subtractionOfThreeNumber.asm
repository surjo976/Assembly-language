...
main proc
    ...
    sub bl,bh        ;That's mean bl = bl - bh  ;it's work with ascii value. If bl is 1 and bh is 0 thats mean bl = 49 and bh =48 in ascii value. The subtraction of bl and bh = 49-48 = 1.
